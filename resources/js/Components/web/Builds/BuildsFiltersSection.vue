...
const clearFilters = () => {
  ...
  buildsFilterStore.getBuilds();
}
</script>

<template>
  <div
    :class="modalStore.showBuildsFiltersModal
  ...
  <aside
    :class="modalStore.showBuildsFiltersModal
      ? 'translate-x-0 ease-in-out transition-all duration-400 flex flex-col gap-5 bg-white h-full p-8 w-3/4 min-[400px]:w-72 sm:w-2/4 md:w-2/5 overflow-y-auto z-40 fixed top-0 right-0 lg:h-max lg:p-6 lg:w-[15.5rem] lg:sticky lg:top-[5.5rem] left:0 lg:border lg:border-gray-300 lg:rounded-lg lg:z-10 lg:hover:shadow-lg lg:hover:shadow-gray-500/100'
      : 'max-lg:translate-x-[200%] max-lg:ease-in-out max-lg:transition-all duration-300 flex flex-col gap-5 bg-white h-full p-8 w-3/4 min-[400px]:w-72 sm:w-2/4 md:w-2/5 overflow-y-auto z-40 fixed top-0 right-0 lg:h-max lg:p-6 lg:w-[15.5rem] lg:sticky lg:top-[5.5rem] 2xl:top-[8rem] left:0 lg:border lg:border-gray-300 lg:rounded-lg lg:z-10 lg:hover:shadow-lg lg:hover:shadow-gray-500/100'"
  >
    <form @submit.prevent="buildsFilterStore.getBuilds()">
