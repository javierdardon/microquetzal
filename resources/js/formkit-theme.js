...
export default {
    ...
    global: {
      ...
      input: '$reset font-mono border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-white focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm',
      label: '$reset block mb-2 font-bold text-base dark:text-white',
      legend: 'font-bold text-sm',
      loaderIcon: 'inline-flex items-center w-4 text-gray-600 animate-spin',
      message: '$reset text-red-500 text-xs',
      messages: 'list-none p-0 mt-1 mb-0',
      outer: '$reset mb-6 grow formkit-disabled:opacity-50',
    ...
    'family:text': {
      ...
      input: 'w-full px-3 py-2 border-none text-base dark:text-white placeholder-gray-400',
    },
    'family:date': {
      inner: 'flex items-center max-w-md ring-1 ring-gray-400 focus-within:ring-blue-500 focus-within:ring-2 [&>label:first-child]:focus-within:text-blue-500 rounded mb-1',
    ...
    file: {
      ...
      noFiles: '$reset font-mono flex w-full items-center px-3 py-2 dark:text-white',
    ...
    select: {
      ...
      input: 'w-full pl-3 pr-8 py-2 border-none text-base placeholder-gray-400 formkit-multiple:p-0 data-[placeholder="true"]:text-gray-400 formkit-multiple:data-[placeholder="true"]:text-inherit',
      option: 'formkit-multiple:p-3 formkit-multiple:text-sm text-gray-400'
    },
    textarea: {
      ...
      input: 'block w-full h-32 px-3 py-3 border-none text-base dark:text-white placeholder-gray-400 focus:shadow-outline',
    },
